...
export class GroupUI implements GroupUII {
    ...
    update() {
        this.g = this.g.data(this.layoutContext.dataManager.groupManager.groups.getVisibleGroups(this.layoutContext.collapseLevel, this.layoutContext.isAutoExpand()), function(d: Group) { return d.d3_id(); });
        this.g.exit().remove();
