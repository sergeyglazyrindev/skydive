...
export class EdgeUI implements EdgeUII {
    ...
    update() {
        ...
        this.layoutContext.dataManager.edgeManager.edges.edges.forEach((e: Edge) => {
    ...
    linkWraps() {
        const visibleNodes = this.layoutContext.dataManager.nodeManager.nodes.getVisibleNodes(this.layoutContext.collapseLevel, this.layoutContext.isAutoExpand());
        return this.layoutContext.dataManager.edgeManager.edges.getVisibleEdges(visibleNodes).reduce((accum: any, e: Edge) => {
